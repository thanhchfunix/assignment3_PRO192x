...
public class EmployeeManagement {
  ...
  public void docFile(File file) {
    ...
    try {
      ...
      while ((line = br.readLine()) != null) {
        if (line.substring(0, 5).equals("Staff")) {
          Staff s = new Staff();
        ...
        if (line.substring(0, 7).equals("Teacher")) {
  ...
  public void editByName(String nameEdit) {
    for (int i = 0; i < listE.size(); i++) {
      if (listE.get(i).getFullName().contains(nameEdit)) {
        edit(i);
      }
    }
    File file = new File(getInfo());
  ...
  public void edit(int i) {
    if (listE.get(i) instanceof Staff) {
      ...
      int j = PRO192xA3.inputInt();
      while (j < 1 || j > 3) {
        System.out.println("Error - type again:");
        j = PRO192xA3.inputInt();
      }
      if (j == 1)
        s.setPosition(EPosition.HEAD);
      if (j == 2)
      ...
      s.setSalaryRatio(PRO192xA3.inputFloat());
      System.out.print("Number of working days: ");
      s.setNoOfWorkingDay(PRO192xA3.inputInt());
      listE.set(i, s);
    }
    if (listE.get(i) instanceof Teacher) {
      ...
      if (j == 3)
        t.setDegree(EDegree.MASTER);
      System.out.print("Sal Ratio: ");
      t.setSalaryRatio(PRO192xA3.inputFloat());
      System.out.print("Number of teaching hours: ");
      t.setTeachingHours(PRO192xA3.inputInt());
      listE.set(i, t);
    }
  }
